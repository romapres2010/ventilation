![схема_малая](https://github.com/romapres2010/ventilation/blob/master/img/схема_малая.png)

Хочу поделиться опытом проектирования, монтажа и эксплуатации своей системы приточной вентиляции совмещенной с канальным кондиционером. [Система](https://github.com/romapres2010/ventilation/blob/master/img/схема_полная_200.png)
...
Будучи новичком в проектировании и монтаже систем вентиляции я прибегал к постоянной помоще и советам мастеров с форума [my.mastergrad.com](https://my.mastergrad.com/).
...
Для себя решил, что нужно минимум 80 (м3/ч) на комнату, с двумя человеками. Если хотите почувствовать свежесть, то нужно около 120 (м3/ч).
...
- шум в распределительных устройствах. Нужно во первых создать перед решеткой зону статического давления и понизить скорость в самой решетке.
