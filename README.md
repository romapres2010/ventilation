...
Хочу поделиться опытом проектирования, монтажа и эксплуатации своей системы приточной вентиляции совмещенной с канальным кондиционером. [Система](./img/схема_полная_200.png)
 собиралась в 2012-2013 годах, с тех пор находится в постоянной эксплуатации.
...
Будучи новичком в проектировании и монтаже систем вентиляции я прибегал к постоянной помоще и советам местеров с форума [my.mastergrad.com](https://my.mastergrad.com/).
...
Для себя решил, что нужно минимум 80 (м3/ч) на комнату, с двумя человеками. Если хотите почустовать свежесть, то нужно около 120 (м3/ч).
...
В предыдущей квартире я уже пробовал собирать приточную вентиляцию на комопнентах [Soler&Palau](https://www.solerpalau.com/ru-ru/in-line-duct-fans-td-silent-94-serie/). Было выявлено несколько недостатков:
...
В первую очередь, у меня были высокие требования к шуму. А из истоников в приточке несколько:

- шум двигателя вентилятора, особенно при регулировании. Если регулатор семисторный, то от шума ни куда не деться. Либо переходить на трансформаторный регулятор, либо использовать вентиляторы с EC двигателями, которые управляются сигналом 0-10 В.
...
- шум в распределительных устройствах. Нужно во первых создать перед решеткой зону статического довления и понизить скорость в самой решетке.

В качестве производителя комопнент я выбрал продукцию [Systemair](https://systemair-rus.ru/). Отличное качество и очень дорого. Но в 2012 году было вполне еще доступно.
...
По [installation instructions](https://shop.systemair.com/upload/assets/PP-89_ODEN_EN_20190426_184315212.PDF) на камеру статического давления, для меня подходит размер 100мм на 300мм - поток для него около 74 (л/с) при разнице давлений 22 Pa или 52 (л/с) при разнице давлений 11 Pa.

Проникся уважением к шведам - все отверстия в камерах и глушителях были закрыты полиэтиленовыми "шапочками". Несколько фото:

<img src="./img/plenum_box/plenum_box1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/plenum_box/plenum_box2.jpeg?raw=true" alt="drawing" width="300"/>  

<img src="./img/plenum_box/plenum_box3.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/plenum_box/plenum_box4.jpeg?raw=true" alt="drawing" width="300"/> 
...
<img src="./img/grilles/grilles1.png?raw=true" alt="drawing" width="300"/>  <img src="./img/grilles/grilles2.png" alt="drawing" width="300"/>  

На сайте есть отличный калькулятор для проверки праметров каждого из компонент. Например, для [NOVA-A-2-2-300x100](https://design.systemair.com/Global/en-GB/catalogue/NOVA_A?accessories=0&blades=0&damper=1&height=100&length=300&market=0&mounting=2&mounting_frame=0&oden_fixing=1&rows=2&surface_finish=0).  
...
Например, так выглядит распределение воздушного потока в моей комнаты (4,5 х 3,5 м, высота потолков 2,7, расположение решетки в 15 см от потолка в углу комнаты) при разном расходе воздуха (температура в комнате 20 С, тепература подачи 20 С):  

- 60 (м3/ч) и терминальной скорости потока 0,1 м/с  
<img src="./img/grilles/grilles3_60_1.png?raw=true" alt="drawing" width="300"/>  <img src="./img/grilles/grilles3_60_2.png?raw=true" alt="drawing" width="300"/> 

- 120 (м3/ч) и терминальной скорости потока 0,2 м/с  
<img src="./img/grilles/grilles3_120_1.png?raw=true" alt="drawing" width="300"/>  <img src="./img/grilles/grilles3_120_2.png?raw=true" alt="drawing" width="300"/> 

- 250 (м3/ч) и терминальной скорости потока 0,3 м/с  
<img src="./img/grilles/grilles3_250_1.png?raw=true" alt="drawing" width="300"/>  <img src="./img/grilles/grilles3_250_2.png?raw=true" alt="drawing" width="300"/> 

## Разводка воздуховодов

На предыдушей квартире я использовал обычные пластиковые каналы 100 мм или прямоугольные 60х120 мм. Мастера с [my.mastergrad.com](https://my.mastergrad.com/) убедили отказаться от пластика и перейти на витые оцинкованные.

Чтобы снизить шум, в канале желательно держать скороть не выше 2.0-2.5 (м/с). Есть отличная бесплатная программа [Vent-Calc v2.0](http://www.sibclim.ru/2009/06/18/vent-calc-v2.0-programma-dlja-rascheta.html). С ее помощью можно посчитать скорость потока и потери давления для различных элементов системы вентиляции.
...
Нитки каналов в комнаты у меня короткие (кроме одной), я решил заложиться на более мощный вертилятор, в надежде, что он прокачает всю сеть.
...
Подборка фото:  
<img src="./img/tube/tube1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/tube/tube2.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/tube/tube3.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/tube/tube4.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/tube/tube5.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/tube/tube6.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/tube/tube7.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/tube/tube8.jpeg?raw=true" alt="drawing" width="300"/> 
...
- на выходе из кондионера стоит "светофор" на 4 выхода по 160 мм
- для баласнировки воздушной сети на двух коротких ветках стоят ирисовые регуляторы
...
Фото мотажа:  
<img src="./img/air_conditioning/air_conditioning1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/air_conditioning/air_conditioning2.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/air_conditioning/air_conditioning3.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/air_conditioning/air_conditioning4.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/air_conditioning/air_conditioning5.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/air_conditioning/air_conditioning6.jpeg?raw=true" alt="drawing" width="300"/> 
...
- общие потери на сети сотавляли около 150 Па
...
- дале стоит канальный подогреватель и еще один шумоглушитель
- в коридоре стоит еще один фильтр тонкой очистки для фильтрации воздуха в кондиционер (рециркуляция)

<img src="./img/vent/vent1.jpg?raw=true" alt="drawing" width="300"/>  <img src="./img/vent/vent2.jpg?raw=true" alt="drawing" width="300"/> 

<img src="./img/vent/vent3.jpg?raw=true" alt="drawing" width="300"/>  <img src="./img/vent/vent4.jpg?raw=true" alt="drawing" width="300"/> 

<img src="./img/vent/vent5.jpg?raw=true" alt="drawing" width="300"/>  <img src="./img/vent/vent6.jpg?raw=true" alt="drawing" width="300"/> 

## Фильтрация воздуха

Для тонкой очистки фоздуха выбрал кассетный фильтр [Systemair FFR 200](https://shop.systemair.com/en/ffr--200--filter--cassette/p403766).
Фильтрующие элементы планировал использовать:

- класса G3 [BFR 200 Coarse](https://shop.systemair.com/en/bfr--200--coarse--50--filter/p94598). При  потоке 300 (м3/ч) потери на новом фильтре составляют 20 Па. Замена рекомнедуется при потере давления 170 Па.
- класса F7 [BFR 200 ePM1](https://shop.systemair.com/en/ffr--200--filter--cassette/p403766). При  потоке 300 (м3/ч) потери на новом фильтре составляют 75 Па. Замена рекомнедуется при потере давления 250 Па.
...
<img src="./img/filter/filter1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/filter/filter3.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/filter/filter4.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/filter/filter5.jpeg?raw=true" alt="drawing" width="300"/> 
...
<img src="./img/filter/filter6.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/filter/filter7.jpeg?raw=true" alt="drawing" width="300"/> 

## Автоматика

Сделал небольшой щиток:

<img src="./img/automatic/automatic1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/automatic/automatic2.jpeg?raw=true" alt="drawing" width="300"/> 

В щитке оставил запас для контролера автоматики и небольшого трансформатора. Cхема максимально простая:
...
Фото монтажа:  
<img src="./img/kitchen/kitchen1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/kitchen/kitchen2.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/kitchen/kitchen3.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/kitchen/kitchen4.jpeg?raw=true" alt="drawing" width="300"/> 
...
<img src="./img/kitchen/kitchen5.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/kitchen/kitchen6.jpeg?raw=true" alt="drawing" width="300"/> 
...
<img src="./img/finish/finish1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/finish/finish2.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/finish/finish3.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/finish/finish4.jpeg?raw=true" alt="drawing" width="300"/> 

<img src="./img/finish/finish5.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/finish/finish6.jpeg?raw=true" alt="drawing" width="300"/> 
...
- ноябрь 2012 - 613 кВт (теплый месяц был)
- декабрь 2012 - 1208 кВт
- январь 2013 - 1128 кВт (работало не полный месяц - на новый год уезжали)
...
Была жаркая неделя маq 2013 - начал активно использовать кондиционер в режиме охлаждения.

- В режиме приточки расход порядка 300 м3 (по 100 м3 на комнату). Скорость на выходе из решеток - 1,2 м\с
- При включении канального кондиционера на максимальную скорость - расход - 600 м3, из них 300 м3 с приточки и порядка 300 м3 - рецикуляция. Скорость на выходе из решеток - около 3 м\с.

Субъективные наблюдения при работе кондиционера:

- Температруа на выходе из решеток около 11 С.
...
- Так как забор рециркуляционного воздуха сделан возле кондиционера, то в комнатах наблюдается существенный переток воздуха под дверью. При открытых межкомнатных дверях это не заметно, а вот если дверь закрыть - то чуствуется ощутимо.
...
- Смесительный узел соберу сам с трехходовым краном и приводом управления по сигналу 1-10 В
...
<img src="./img/water/water3.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/water/water4.jpeg?raw=true" alt="drawing" width="300"/>

- так выглядит щиток автоматики  
<img src="./img/automatic/automatic3.jpeg?raw=true" alt="drawing" width="400"/>

- так выглядит смесительный узел  
<img src="./img/water/water1.jpeg?raw=true" alt="drawing" width="300"/>  <img src="./img/water/water2.jpeg?raw=true" alt="drawing" width="300"/>
